...
<template>
    <div v-show="message" class="fixed bottom-5 right-5 z-50 space-y-4">
        <div class="container mx-auto mt-10 space-y-5">
            <div class="flex justify-between shadow-inner p-4 text-sm text-white rounded-lg bg-rose-400">
