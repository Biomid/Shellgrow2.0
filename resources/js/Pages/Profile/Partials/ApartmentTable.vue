    ...
    methods: {
        async fetchUsers() {
            try {
                ...
                this.productList.forEach(apartment => this.flattenOwner(apartment));
        ...
        flattenOwner(apartment) {
            if (apartment && apartment.owner && apartment.owner.name) {
        ...
        searchUsers() {
            const searchTerm = this.searchTerm.toLowerCase();
            this.rowsToShow = this.productList.filter((apartment) => {
                const lowerCaseOwnerName = apartment.name.toLowerCase();
